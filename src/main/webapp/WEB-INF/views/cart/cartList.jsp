			...
			<div class="col-lg-8">
				<div class="blog__details__text">
					<div class="blog__details__video set-bg"
						data-setbg="/resources/img/blog/details/blog-video-bg.jpg">
					</div>
					<p>You have finished building your own website. You have
						introduced your company and presented your products and services.
						You have added propositions and promos to catch your target
						audience’s attention. You think you are doing everything “right”,
						but all your promotions have failed to produce growth in your new
						internet business. There are many ways for your web site to be
						promoted, but maybe you’re missing the “key” to the “best”
						promotion. Here are some things to consider: – If you have started
						to promote your web site, keep it constant. If you promote your
						site with persistence, it will catch your audience’s attention. –
						Be patient. Try each different promotion until you find the best.</p>
					<h5>Cattle She’d Days Lights Light Saw Spirit Shall</h5>
					<p>Free promotions such as search engines and directories would
						...
						type of free promotion is right for you. – Make a deal with other
